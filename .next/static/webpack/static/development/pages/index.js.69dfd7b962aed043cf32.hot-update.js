...
var Footer = function Footer() {
  ...
  return __jsx("div", {
    className: styled_jsx_style__WEBPACK_IMPORTED_MODULE_1___default.a.dynamic([["529677071", [!_babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(selected).length == 0 ? '#fd6568' : '#C3C3C3', 'animate' + selected.mal_id]]]) + " " + "footer",
    __source: {
    ...
    className: styled_jsx_style__WEBPACK_IMPORTED_MODULE_1___default.a.dynamic([["529677071", [!_babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(selected).length == 0 ? '#fd6568' : '#C3C3C3', 'animate' + selected.mal_id]]]),
    __source: {
      fileName: _jsxFileName,
      lineNumber: 20
    },
    ...
    className: styled_jsx_style__WEBPACK_IMPORTED_MODULE_1___default.a.dynamic([["529677071", [!_babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(selected).length == 0 ? '#fd6568' : '#C3C3C3', 'animate' + selected.mal_id]]]) + " " + "buttonWrapper",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 21
    },
    ...
    __self: this
  }, ".footer.__jsx-style-dynamic-selector{width:100%;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-pack:end;-webkit-justify-content:flex-end;-ms-flex-pack:end;justify-content:flex-end;position:absolute;bottom:0;z-index:0;}.buttonWrapper.__jsx-style-dynamic-selector{background-color:transparent;min-height:150px;-webkit-flex:0 0 30%;-ms-flex:0 0 30%;flex:0 0 30%;}.openTrailers.__jsx-style-dynamic-selector{background-color:".concat(!_babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(selected).length == 0 ? '#fd6568' : '#C3C3C3', ";height:75px;-webkit-flex:0 0 50%;-ms-flex:0 0 50%;flex:0 0 50%;position:relative;left:25%;top:37.5px;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;}.").concat('animate' + selected.mal_id, ".__jsx-style-dynamic-selector{-webkit-animation:animate-__jsx-style-dynamic-selector .5s forwards;animation:animate-__jsx-style-dynamic-selector .5s forwards;}span.__jsx-style-dynamic-selector{font-family:council,sans-serif;font-weight:400;font-style:normal;font-size:2em;color:black;}@-webkit-keyframes animate-__jsx-style-dynamic-selector{0%{-webkit-clip-path:polygon(0 0,49% 0,100% 0,100% 45%,100% 100%,48% 100%,0 100%);-webkit-clip-path:polygon(0 0,49% 0,100% 0,100% 45%,100% 100%,48% 100%,0 100%);clip-path:polygon(0 0,49% 0,100% 0,100% 45%,100% 100%,48% 100%,0 100%);}100%{-webkit-clip-path:polygon(0 5%,60% 20%,60% 0%,95% 56%,59% 100%,60% 80%,0 75%);-webkit-clip-path:polygon(0 5%,60% 20%,60% 0%,95% 56%,59% 100%,60% 80%,0 75%);clip-path:polygon(0 5%,60% 20%,60% 0%,95% 56%,59% 100%,60% 80%,0 75%);}}@keyframes animate-__jsx-style-dynamic-selector{0%{-webkit-clip-path:polygon(0 0,49% 0,100% 0,100% 45%,100% 100%,48% 100%,0 100%);-webkit-clip-path:polygon(0 0,49% 0,100% 0,100% 45%,100% 100%,48% 100%,0 100%);clip-path:polygon(0 0,49% 0,100% 0,100% 45%,100% 100%,48% 100%,0 100%);}100%{-webkit-clip-path:polygon(0 5%,60% 20%,60% 0%,95% 56%,59% 100%,60% 80%,0 75%);-webkit-clip-path:polygon(0 5%,60% 20%,60% 0%,95% 56%,59% 100%,60% 80%,0 75%);clip-path:polygon(0 5%,60% 20%,60% 0%,95% 56%,59% 100%,60% 80%,0 75%);}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */\n/*@ sourceURL=/Users/takaitech/Takai-Tech/anime-trailers-next/components/Footer.js */")));
};
...
//# sourceMappingURL=index.js.69dfd7b962aed043cf32.hot-update.js.map